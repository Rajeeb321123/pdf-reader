...
// IMp: how to pass ref as props . look at forwardRef syntax
const  Message = forwardRef<HTMLDivElement, MessageProps>(({ message, isNextMessageSamePerson }, ref ) => {
    return (
        ...
        >
            <div
                className={cn("relative flex w-6 h-6 aspect-square items-center justify-center", {
            ...
            >
                ...
                >
                    {/* V imp using mark, bulletpoint etc in ai respnse */}
...
// imp if used forwad ref like above
